...
// Custom auth middleware for token generation
...
app.post('/api/call/token', requireAuth, async (req: any, res: any) => {
...
const PORT = process.env.SIGNALING_PORT || 4002;
app.listen(PORT, () => {
  console.log(`Signaling service listening on port ${PORT}`);
});
