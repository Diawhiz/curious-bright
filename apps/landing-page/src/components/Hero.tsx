            ...
            <div className="comment-corner-card bg-white p-6 sm:p-8 relative min-h-[420px] flex flex-col justify-between shadow-xl">
              ...
              <div className="flex items-center justify-between pb-4 border-b border-[var(--color-line)] mb-4">
                ...
                <div className="flex items-center -space-x-2">
                  <div className="w-7 h-7 rounded-full bg-[var(--color-coral)] text-white text-xs font-bold flex items-center justify-center border-2 border-white shadow-xs" title="Amara">A</div>
                  <div className="w-7 h-7 rounded-full bg-[var(--color-teal)] text-white text-xs font-bold flex items-center justify-center border-2 border-white shadow-xs" title="Dr. Chen">C</div>
                  <div className="w-7 h-7 rounded-full bg-[var(--color-mustard)] text-[var(--color-ink)] text-xs font-bold flex items-center justify-center border-2 border-white shadow-xs" title="Prof. Thorne">T</div>
                </div>
              </div>
